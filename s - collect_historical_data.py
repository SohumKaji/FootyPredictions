...
for year in ['2014-2015', '2015-2016', '2016-2017']:
 error_file = open('data/'+year[2:4]+'-'+year[7:]+'/'+'home_away_data_error_log_'+year[2:4]+'_'+year[7:]+'.txt', 'w')
 total_errors = 0
 missing_val = dict()
 ...
 for country, ext in [['eng', '36'], ['ita','34'], ['esp','31'], ['ger', '8'], ['fra', '11']]:
  ...
  #Save Scraped Data:
  with open('data/'+year[2:4]+'-'+year[7:]+'/'+country+'_hist_data_'+year[2:4]+'_'+year[7:]+'.pickle', 'wb') as f:
