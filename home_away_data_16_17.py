...
error_file = open('home_away_data_error_log_16_17.txt', 'w')
...
for country, ext in [['eng', '36'], ['ita','34'], ['esp','31'], ['ger', '8'], ['fra', '11']]:
 ...
 with open(country+'_hist_data_2016_17.pickle', 'wb') as f:
  pickle.dump([home_stats_2016_17, away_stats_2016_17], f)
